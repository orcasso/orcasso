...
final class OrderLineController extends AbstractController
{
    ...
    #[Route('/new/{type}', name: 'order_line_create', methods: ['GET', 'POST'])]
    ...
    #[Route('/{line}', name: 'order_line_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, OrderLine $line): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('order_edit', ['order' => $line->getOrder()->getId()]);
        }
    ...
    #[Route('/{line}/delete', name: 'order_line_delete', methods: ['GET', 'POST'])]
    public function delete(Request $request, OrderLine $line): Response
    {
        ...
        return $this->render('order_line/delete.html.twig', [
            'line' => $line,
            'form' => $form->createView(),
        ]);
    }
