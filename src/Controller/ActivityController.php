...
final class ActivityController extends AbstractController
{
    ...
    #[Route('/_list', name: 'activity_list_ajax')]
    ...
    #[Route('/new', name: 'activity_create', methods: ['GET', 'POST'])]
    public function create(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('activity_edit', ['activity' => $activity->getId()]);
        }
    ...
    #[Route('/{activity}', name: 'activity_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{activity}/delete', name: 'activity_delete', methods: ['GET', 'POST'])]
