...
final class PaymentOrderController extends AbstractController
{
    ...
    #[Route('/new', name: 'payment_order_create', methods: ['GET', 'POST'])]
    public function create(Request $request, Payment $payment): Response
    {
        ...
        return $this->render('payment_order/create.html.twig', [
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{paymentOrder}', name: 'payment_order_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, PaymentOrder $paymentOrder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('payment_edit', ['payment' => $paymentOrder->getPayment()->getId()]);
        }

        return $this->render('payment_order/edit.html.twig', [
            'order' => $paymentOrder,
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{paymentOrder}/delete', name: 'payment_order_delete', methods: ['GET', 'POST'])]
    public function delete(Request $request, PaymentOrder $paymentOrder): Response
    {
        ...
        return $this->render('payment_order/delete.html.twig', [
            'order' => $paymentOrder,
            'form' => $form->createView(),
        ]);
    }
